    ...
    <div className="portfolio">
      ...
      <div className="content">
        <section className="section">
          <h2>Introduction</h2>
          <p>
            I'm V.Sree Varshitha, a B.Tech student with a passion for Artificial
        ...
        <section className="section">
          <h2>Projects</h2>
          <ul>
            <li>Developed a online movie ticket booking system </li>
        ...
        <section className="section">
          <h2>Contact</h2>
          <a href="mailto:varshithavaddi2004@gmail.com">Email me</a>
        </section>
      </div>
    </div>
  );
